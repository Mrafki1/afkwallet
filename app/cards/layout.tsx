...
export const metadata: Metadata = {
  title: "Best Canadian Credit Cards 2026",
  ...
  keywords: ["best Canadian credit card 2026", "credit card comparison Canada", "Aeroplan card", "Amex Canada", "no fee credit card Canada", "travel credit card Canada", "cash back credit card Canada"],
  alternates: { canonical: "/cards" },
  openGraph: {
    title: "Best Canadian Credit Cards 2026 | PointsBinder",
